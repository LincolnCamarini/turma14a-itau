...
<h1> Um deploy automático feito com alunos do itaú </h1>

<div style="display:flex">
<div style="width:100px;height:100px;background:yellow; padding:50px;margin:50px">
    Um teste em um quadrado amarelo
    </div>
